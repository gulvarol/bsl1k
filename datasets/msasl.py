...
class MSASL(VideoDataset):
    def __init__(
        ...
        gpu_collation=False,
        use_bbox=True,
        monolithic_pkl_path="data/pickled-videos/msasl-compressed-quality-90-resized-256x256.pkl",
        input_type="rgb",
